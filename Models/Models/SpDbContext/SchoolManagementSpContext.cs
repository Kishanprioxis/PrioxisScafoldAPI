...
{
    public partial class SchoolManagementSpContext : DbContext
    {
        public SchoolManagementSpContext() { }
        public SchoolManagementSpContext(DbContextOptions<SchoolManagementSpContext> options)
            : base(options)
        {
        }
